...
# # AWS inspetor resourcegroup for tagged slection
...
resource "aws_inspector_assessment_target" "assessment_target" {
  ...
  # resource_group_arn = aws_inspector_resource_group.inspector_group.arn # remove/comment out to hit ec2 globally
}
