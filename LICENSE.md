...
1.  **Preamble:** This Agreement, signed on Jan 25, 2018 (hereinafter:
    ...
    using tradeblock Terraform Modules (hereinafter: The Software) created and
...
2.  **License Grant:** Licensor hereby grants Licensee a Personal,
    ...
    5.  **Non-Commercial: **Licensee may not use Software for
        commercial purposes. for the purpose of this license, commercial
        purposes means that a 3rd party has to pay in order to access
        Software or that the Website that runs Software is behind
        a paywall.

3.  **Term & Termination:** The Term of this license shall be
    until terminated. Licensor may terminate this Agreement, including
...
8.  **Warranty:  **
    ...
    2.  **No-Warranty:** The Software is provided without any warranty;
        ...
        Licensee’s computers or to Licensee, and that Software shall
        be functional. Licensee shall be solely liable to any damage,
